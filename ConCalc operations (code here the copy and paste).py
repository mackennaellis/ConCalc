...
while True:
    ...
    if what_shape == '1':
        ...
        enter_line()
        height = int(input('\033[0m' + 'What is the height of the cuboid? '))
        enter_line()
        width = int(input('What is the width of the cuboid? '))
        enter_line()
        ...
        print(f'\033[0m' + "Your cuboid's volume is: " '\033[1m' f'{cuboid_volume}')
        enter_line()
        print('☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲')
        ...
        enter_line()
        measurement = int(input('\033[0m' + 'What is the side measurement of the cuboid? '))
        enter_line()
        ...
        print(f'\033[0m' + "Your cube's volume is: " '\033[1m' f'{cube_volume}')
        print('☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲')
        enter_line()
        break
    elif what_shape == '3':
        ...
        print(f'\033[0m' + "Your cuboid's volume is: " '\033[1m' f'{cylinder_volume_rounded}')
        enter_line()
        print('☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲')
        break
    elif what_shape == '4':
